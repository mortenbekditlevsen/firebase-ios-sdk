 ...
 */
@objc(FIRAuthErrors) class AuthErrors: NSObject {

    @objc(FIRAuthErrorDomain) static var AuthErrorDomain: String = "FIRAuthErrorDomain"

    @objc (FIRAuthErrorUserInfoNameKey) static var AuthErrorUserInfoNameKey: String = "FIRAuthErrorUserInfoNameKey"
    ...
    /**
     ...
     exists.
     */
    @objc(FIRAuthErrorUserInfoEmailKey) static var AuthErrorUserInfoEmailKey: String = "FIRAuthErrorUserInfoEmailKey"
     ...
     */
    @objc(FIRAuthErrorUserInfoUpdatedCredentialKey) static var AuthErrorUserInfoUpdatedCredentialKey: String = "FIRAuthErrorUserInfoUpdatedCredentialKey"
     ...
     */
    @objc(FIRAuthErrorUserInfoMultiFactorResolverKey) static var AuthErrorUserInfoMultiFactorResolverKey: String = "FIRAuthErrorUserInfoMultiFactorResolverKey"
 ...
 */
private let kFIRAuthErrorMessageCustomTokenMismatch = "The custom token corresponds to a different audience."
 ...
 */
private let kFIRAuthErrorMessageInvalidCredential = "The supplied auth credential is malformed or has expired."

/** @var kFIRAuthErrorMessageUserDisabled
    @brief Message for @c FIRAuthErrorCodeUserDisabled error code.
 */
private let kFIRAuthErrorMessageUserDisabled = "The user account has been disabled by an administrator."

/** @var kFIRAuthErrorMessageEmailAlreadyInUse
    @brief Message for @c FIRAuthErrorCodeEmailAlreadyInUse error code.
 */
private let kFIRAuthErrorMessageEmailAlreadyInUse = "The email address is already in use by another account."

/** @var kFIRAuthErrorMessageWrongPassword
    @brief Message for @c FIRAuthErrorCodeWrongPassword error code.
 */
private let kFIRAuthErrorMessageWrongPassword = "The password is invalid or the user does not have a password."
 ...
 */
private let kFIRAuthErrorMessageNoSuchProvider = "User was not linked to an account with the given provider."
